...
- Specification of the `AFFIRM` attribute without the `SYNC` attribute is deprecated and will not be supported in future releases. <<<<<<<<<<<<< deprecated 예정...
...
case ) noaffirm 을 명시적으로 설정하지 않아 서비스 지연
https://thingsidealwith.wordpress.com/2015/03/28/of-lgwr-arch-async-and-noaffirm/
