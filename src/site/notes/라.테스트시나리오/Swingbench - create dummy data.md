---
{"dg-publish":true,"permalink":"/라.테스트시나리오/Swingbench - create dummy data/","dgPassFrontmatter":true,"noteIcon":""}
---
...
export TNS_ADMIN=/root/ucp/network/admin
export JAVA_TOOL_OPTIONS="-Doracle.net.tns_admin=${TNS_ADMIN}"
./oewizard -cl -create -cs ORCL_UCP_ADG -u soe -p soe -scale 100 -tc 1 -dba "system" -dbap "manager1!" -ts SOE -bigfile -allindexes -dt thin -hashpart
```
